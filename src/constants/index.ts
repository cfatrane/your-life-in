...
const LIFE_PERIOD = [
  ...
  { min: 11, max: 14, label: "Collège", color: "bg-yellow-400" },
  { min: 14, max: 18, label: "Lycée", color: "bg-orange-400" },
  { min: 18, max: 21, label: "Université", color: "bg-purple-500" },
  { min: 21, max: 64, label: "Carrière", color: "bg-red-500" },
